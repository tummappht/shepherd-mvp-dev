...
export default function Diagram() {
    ...
    useEffect(() => {
        const startDelay = 180000; // 3 minutes
        const revealDelay = 3600;  // 3.6 seconds per node
        ...
        const timer = setTimeout(() => {
            ...
            // Optional: edge highlight on hover
            /*
        ...
        }, startDelay); // ⏱ Start rendering after 3 minutes
